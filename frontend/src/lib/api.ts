...
export const api = {
  ...
  transactions: {
    ...
    deleteAll: () => api.request('/transactions', { method: 'DELETE' }),
  },
  ...
  categories: {
    ...
    delete: (id: number) => api.request(`/categories/${id}`, { method: 'DELETE' }),
  },
  ...
  budgets: {
    ...
    update: (id: number, data: any) => api.request(`/budgets/${id}`, { method: 'PATCH', body: JSON.stringify(data) }),
  ...
  debts: {
    ...
    update: (id: number, data: any) => api.request(`/debts/${id}`, { method: 'PATCH', body: JSON.stringify(data) }),
  ...
  goals: {
    ...
    update: (id: number, data: any) => api.request(`/goals/${id}`, { method: 'PATCH', body: JSON.stringify(data) }),
  ...
  recurring: {
    ...
    update: (id: number, data: any) => api.request(`/recurring/${id}`, { method: 'PATCH', body: JSON.stringify(data) }),
