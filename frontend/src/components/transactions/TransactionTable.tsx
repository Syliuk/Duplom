...
function TransactionTable({ transactions, onDelete, onEdit, deletingIds = {} }: TransactionTableProps) {
                ...
                <td className="p-5">
                  <div className="flex gap-2 justify-end">
                    ...
                    <button
                      ...
                      disabled={deletingIds[transaction.id]}
                      className="p-2 text-gray-400 hover:text-red-600 disabled:opacity-50 disabled:cursor-not-allowed transition"
                    >
                      <Trash2 size={18} />
                    </button>
                  </div>
