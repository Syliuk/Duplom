        ...
        <div className="grid gap-4 md:grid-cols-2 xl:grid-cols-3 flex-1">
          ...
          <div className="space-y-2">
            ...
            <select
              ...
              className="w-full bg-white text-slate-950 dark:bg-slate-800 dark:text-white border border-gray-400 dark:border-slate-600 rounded-xl px-4 py-3 outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
            >
